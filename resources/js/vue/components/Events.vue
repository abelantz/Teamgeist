                ...
                <div class="card card-success card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <button @click="addEventModal" class="btn btn-succes bg-success">Add Event</button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="tag tag-warning">Sponsorday</span></td>
                                    <td>11-7-2014</td>
                                    <td>
        ...
        <div class="modal  fade" id="addEvent" tabindex="-1" role="dialog" aria-labelledby="addEvent"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="form-group">
                        <label>Place</label>
                        <input type="text" class="form-control" placeholder="Select place from Google Map ...">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox">
                          <label class="form-check-label">Board</label>
                        </div>
                    </div>
                    </div>
